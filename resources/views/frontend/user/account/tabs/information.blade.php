...
<hr>
<form method="post" action="{{route('frontend.user.profile.avatar')}}" enctype="multipart/form-data">
{{ csrf_field() }} 
<div class="form-group row">
 <label for="avatar" class="col-md-3 col-form-label text-md-right">@lang('translator.avatar')</label>
 <div class="col-md-9">
    <input type="file" name="avatar" id="avatar">
 </div>
</div>
<div class="form-group">
    <button class="btn btn-primary btn-sm float-right">@lang('translator.save')</button>
</div>
</form>