                ...
                <div class="comment-wrapper">
                    <div class="w-100 d-inline-block">
                        <div class="comment-text-wrapper">
                          ...
                          @if(App::getLocale() =='sq') Postuar nga : @else  Postet by @endif  <strong>{{$comment->user->name}}</strong> @if(App::getLocale() =='sq') në Çështjen  @else  on @endif <strong>{{$comment->issue->title}}</strong> @if(App::getLocale() =='en') Issue. @endif
                        </div>
